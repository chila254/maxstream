...
class VideoPlayerOptions {
  ...
  VideoPlayerOptions({
    ...
    this.maxBufferDurationMs,
       ...
       assert(
         maxBufferDurationMs == null || maxBufferDurationMs >= 0,
         'maxBufferDurationMs must be zero or greater',
       );
  ...
  /// current playback position before ExoPlayer stops buffering.
  ///
  /// Defaults to the ExoPlayer default (50s) when unset. Ignored on platforms
  /// that do not support configuring the max buffer duration.
